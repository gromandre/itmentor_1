'''
    Реализуйте поведение класса, при котором использование его объектов в арифметических
    выражениях будет выполнять сложение, вычитание, умножение или деление их площадей:
    object1 + object2 == object1.square + object2.square
'''
...
sq2 = Quadrilateral([(0,0), (0,8), (4,8), (10,0)])

print(f'{sq.square + sq2.square} = {sq.square} + {sq2.square}')
print(sq + sq2 == sq.square + sq2.square)
