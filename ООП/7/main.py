'''
    Добавьте в класс BasicShape метод add(coordinate: tuple[float, float]),
    который добавляет новую точку в многоугольник. Сделайте так, чтобы он не работал в классе Quadrilateral.
'''
