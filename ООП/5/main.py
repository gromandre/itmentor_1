'''
    ...
    Добавьте в новый класс методы is_rectangle и is_square, проверяющие, является ли четырехугольник
    прямоугольником (противоположные стороны и диагонали равны) и квадратом (все стороны и диагонали равны) соответственно.
'''
...
class Quadrilateral(BasicShape):
    ...
    def get_len_side(self, point1: tuple[float, float], point2: tuple[float, float]) -> float:
...
print(sq.is_rectangle(), sq.is_square())
